    ...
    <div class="container-fluid">
  	...
  	<div class="containerX">
        <div class ="title">Donor Details</div>	
        	<form action="AddCampaignCity" method = "post" id="province" >
        	...
        	<form action="AddCampaignCity" method = "post" id="state" onchange="submitState()" >
        	<div class="user-details"> 
        	<div class="input-box">
        	...
        	<form action="AddCampaignCity" method = "post" >
        	<div class="user-details"> 
        	<div class="input-box">
