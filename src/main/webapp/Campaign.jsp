        ...
        <div class="row">
            ...
            <div class="col-md-4 mb-3">
                <div class="card campaign-card">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">Gampaha Blood Donation Campaign</h5>
                        <p class="card-text">Gampaha Blood Donation Campaign Organized by Youth Center...</p>
                        <ul class="list-unstyled">
                            <li><strong>Date :</strong> 28/04/2024</li>
                            <li><strong>Time :</strong> 09:00 AM</li>
                        ...
                        <div class="col-md-4 mb-3">
                <div class="card campaign-card">
                    <img class="card-img-top" src="images/crd8.jpeg" alt="Campaign Image">
                    <div class="card-body">
                        <h5 class="card-title">Nugegoda Blood Donation Campaign</h5>
                        <p class="card-text">Nugegoda Blood Donation Campaign Organized by Anula Vidyalaya...</p>
                        <ul class="list-unstyled">
                            <li><strong>Date :</strong> 05/05/2024</li>
                            <li><strong>Time :</strong> 10:00 AM</li>
                            <li><strong>Location :</strong> Anula Vidyalaya</li>
                        </ul>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-md-4 mb-3">
                <div class="card campaign-card">
                    <img class="card-img-top" src="images/crd9.jpeg" alt="Campaign Image">
                    <div class="card-body">
                        <h5 class="card-title">Anuradhapura Blood Donation Campaign</h5>
                        <p class="card-text"> Anuradhapura Blood Donation Campaign Organized by Youth Center ...</p>
                        <ul class="list-unstyled">
                            <li><strong>Date :</strong> 28/05/2024</li>
                            <li><strong>Time :</strong> 09:00 AM</li>
                            <li><strong>Location :</strong> Youth Center</li>
                        </ul>
                    </div>
